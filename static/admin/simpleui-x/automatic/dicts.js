...
var dicts = {
    ...
    'fas fa-hammer': ['维护管理'],
    //后台进程管理
    'fas fa-layer-group': ['后台进程管理'],
    //作业流程
    'fas fa-sitemap': ['作业流程'],
    //接口任务管理
    'fas fa-rectangle-list': ['接口任务管理'],
    //任务结果
    'fas fa-feather-pointed': ['任务结果'],
    //周期任务
    'fas fa-sliders': ['周期任务'],
    //短信管理
    'fas fa-square-envelope': ['短信管理'],
    //认证和授权
    'fas fa-shield-halved': ['认证和授权'],
    //工具
    'fas fa-wrench': ['工具'],
    //系统
